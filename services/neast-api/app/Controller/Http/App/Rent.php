...
class Rent extends AbstractController
{
    ...
    public function create(RequestInterface $request): ResponseInterface
    {
        $validator = di(ValidatorFactory::class)->make($request->all(), [
            ...
            'agreement_start' => 'required|date_format:Y-m',
            'agreement_end' => 'required|date_format:Y-m',
            ...
            'agreement_start.required' => 'Agreement start is required',
            'agreement_start.date_format' => 'Invalid agreement start',
            'agreement_end.required' => 'Agreement end is required',
            'agreement_end.date_format' => 'Invalid agreement end',
