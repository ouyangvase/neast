...
/// | Scaffold + CustomScrollView + SliverAppBar（刷新在 AppBar 下方） | [headerPosition] = locator + [HeaderLocator.sliver] |
/// | Scaffold + CustomScrollView + SliverAppBar（刷新在屏幕顶）       | true         |
...
class AppRefresher extends StatelessWidget {
  ...
  /// 下拉刷新指示器位置。
  ///
  /// 默认 [IndicatorPosition.above]（屏幕顶部）。
  /// 当页面有固定 / 折叠 [SliverAppBar] 且希望刷新出现在 AppBar 下方时，
  /// 传 [IndicatorPosition.locator]，并在 [CustomScrollView] 的 slivers 里
  /// 于 AppBar 之后插入 [HeaderLocator.sliver]。
  ...
  // ============== 主题色 ==============
  static const Color _accent = Color(0xFF234FA5);
