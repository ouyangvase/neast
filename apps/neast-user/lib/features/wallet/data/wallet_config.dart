...
abstract final class WalletConfig {
  ...
  static const defaultPaymentMethodId = 'grab';

  /// App 支付方式 ID → Fiuu mp_channel（后端也会映射，此处供前端兜底/展示）。
  static const fiuuChannelByPaymentMethodId = {
    'fpx': 'fpx',
    'tng': 'TNG-EWALLET',
    'grab': 'GrabPay',
    'visa': 'credit',
  ...
  static String? fiuuChannelFor(String paymentMethodId) {
    return fiuuChannelByPaymentMethodId[paymentMethodId];
  }
}
