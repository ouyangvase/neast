...
import 'package:neast/features/give_points/pages/give_points_screen.dart';
...
import 'package:neast/features/scan/pages/scan_screen.dart';
import 'package:neast/features/settlement/pages/settlement_screen.dart';

final selectedIndexProvider = StateProvider<MainTab>((ref) => MainTab.scan);

enum MainTab { scan, givePoints, settlement, account }
        ...
        body: Column(
          ...
          children: [
            ...
            Expanded(
              child: Stack(
                children: [
                  IndexedStack(index: selectedTab.index, children: _pages),
                  if (kShowBetaTag)
                    Positioned(
            ...
            child: BottomNavigationBar(
              ...
              items: [
                BottomNavigationBarItem(
                  icon: _tabIcon(MainTabAssets.scan),
                  activeIcon: _tabIcon(MainTabAssets.scanAct),
                  label: 'Scan',
                ),
                BottomNavigationBarItem(
                  icon: _tabIcon(MainTabAssets.givePoints),
                  activeIcon: _tabIcon(MainTabAssets.givePointsAct),
                  label: 'Give Points',
                ),
                BottomNavigationBarItem(
                  icon: _tabIcon(MainTabAssets.settlement),
                  activeIcon: _tabIcon(MainTabAssets.settlementAct),
                  label: 'Settlement',
                ),
                BottomNavigationBarItem(
