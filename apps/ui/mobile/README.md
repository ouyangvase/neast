...
| `GuestLoginPlaceholder`  | `onLoginPress`, `title`, `message`, `loginLabel`                                                                      | guest-mode CTA card                                             |
| `BrandHeader`            | `title` / `richTitle`, `subtitle`, `onBack`, `right`                                                                  | Flutter `neast_brand_header`                                    |
